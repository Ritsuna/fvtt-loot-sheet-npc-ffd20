...
export class LootSheetFFD20NPC extends game.ffd20.applications.ActorSheetFFD20NPC {
  ...
  async _updateObject(event, formData) {
    ...
    for(let i=0; i<flags.length; i++) {
      ...
      if( name.length == 4 ) { // Ex : data.flags.lootsheetnpcffd20.dragEnabled
  ...
  /**
   * Required because FFD20 _onSubmit tries to updateItems too, which blocks close operation and do other side effects
   */
